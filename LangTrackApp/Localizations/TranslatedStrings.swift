...
//  LangTrackApp
//
//  Created by Easter Bunny on 2020-05-16.
...
let translatedEBLab = "EBLab".localized
let translatedEasterbunnyUniversityEBLab = "Easterbunny University EBLab".localized
let translatedEasterbunnyUniversity = "Easterbunny University".localized
let translatedNoContactWithServer = "No contact with server".localized
let translatedAboutText1 = "aboutText1".localized
let translatedEasterInfo = "EasterInfo".localized
let translatedEasterInfo = "EasterInfo".localized
let translatedEasterInfo = "EasterInfo".localized
let translatedEasterInfo = "EasterInfo".localized
let translatedEasterInfo = "EasterInfo".localized
